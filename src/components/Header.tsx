    ...
    return (
        <>
            <nav className="bg-gray-900 border-gray-200 px-2 sm:px-4 py-2.5 z-10">
                <div className="container pt-3 w-full flex flex-row flex-wrap justify-end md:justify-center items-center mx-auto text-xl">
                    ...
                    <div className={hideMenu ? "hidden w-full md:block md:w-auto" : "w-full md:block md:w-auto"}>
                        <ul className="flex flex-col mt-4 sm:w-full md:justify-evenly md:flex-row md:space-x-24 md:mt-0 md:text-md md:font-medium">
                            <li>
